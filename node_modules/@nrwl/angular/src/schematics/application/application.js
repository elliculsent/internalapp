...
function updateTsLintConfig(options) {
    return schematics_1.chain([
        ...
        workspace_1.updateJsonInTree(`${options.appProjectRoot}/tslint.json`, (json) => {
            json.extends = `${devkit_1.offsetFromRoot(options.appProjectRoot)}tslint.json`;
            json.linterOptions = {
                exclude: ['!**/*'],
            };
            return json;
    ...
    return (host) => {
        return schematics_1.chain([
            ...
            workspace_1.updateJsonInTree(`${options.appProjectRoot}/tsconfig.app.json`, (json) => {
                return Object.assign(Object.assign({}, json), { extends: `./tsconfig.json`, compilerOptions: Object.assign(Object.assign({}, json.compilerOptions), { outDir: `${devkit_1.offsetFromRoot(options.appProjectRoot)}dist/out-tsc` }), exclude: options.enableIvy
                        ? undefined
        ...
        return schematics_1.chain([
            ...
            workspace_1.addLintFiles(options.appProjectRoot, options.linter, {
                ...
                localConfig: options.linter === "tslint" /* TsLint */
                    ? undefined
                    : lint_1.createAngularEslintJson(options.appProjectRoot, options.prefix),
                extraPackageDeps: options.linter === "tslint" /* TsLint */
                    ? undefined
                    : lint_1.extraEslintDependencies,
            }),
