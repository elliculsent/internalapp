...
NgcCookieConsentConfig.ɵfac = function NgcCookieConsentConfig_Factory(t) { return new (t || NgcCookieConsentConfig)(); };
NgcCookieConsentConfig.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NgcCookieConsentConfig, factory: NgcCookieConsentConfig.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgcCookieConsentConfig, [{
        type: Injectable
...
NgcCookieConsentService.ɵfac = function NgcCookieConsentService_Factory(t) { return new (t || NgcCookieConsentService)(ɵngcc0.ɵɵinject(WindowService), ɵngcc0.ɵɵinject(NgcCookieConsentConfig)); };
NgcCookieConsentService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NgcCookieConsentService, factory: NgcCookieConsentService.ɵfac });
/** @nocollapse */
NgcCookieConsentService.ctorParameters = () => [
    { type: WindowService, },
    { type: NgcCookieConsentConfig, },
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgcCookieConsentService, [{
        type: Injectable
    }], function () { return [{ type: WindowService }, { type: NgcCookieConsentConfig }]; }, null); })();
...
NgcCookieConsentModule.ɵfac = function NgcCookieConsentModule_Factory(t) { return new (t || NgcCookieConsentModule)(); };
NgcCookieConsentModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NgcCookieConsentModule });
NgcCookieConsentModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[
            CommonModule
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgcCookieConsentModule, { imports: function () { return [CommonModule]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgcCookieConsentModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule
